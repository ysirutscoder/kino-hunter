...
let MoviesListComponent = class MoviesListComponent {
    constructor(moviesService, router, route) {
        this.moviesService = moviesService;
        this.router = router;
        this.route = route;
        this.movies = [];
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.moviesService.fetchMovies();
...
class Movie {
    constructor(id, original_title, title, overview, release_date, poster_path, backdrop_path) {
        this.id = id;
...
class MoviesService {
    ...
    fetchMovies() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let url = `${this.httpConfig.baseUrl}/movie/popular?api_key=${this.httpConfig.apiKey}&language=${this.httpConfig.language}&page=1&region=RU`;
            let response = yield fetch(url, { method: "GET" });
            let films = yield response.json();
            films.results.forEach(movie => {
                this.movies.push(new _movie_model__WEBPACK_IMPORTED_MODULE_1__["Movie"](movie.id, movie.original_title, movie.title, movie.overview, movie.release_date, movie.poster_path, movie.backdrop_path));
            });
        });
    }
}
